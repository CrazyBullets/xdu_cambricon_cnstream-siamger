...
#define FILE "/workspace/volume/private/CNStream/samples/udp_test_2/server.jpeg"
int main()
{
  ...
  while(1)
  {
    ...
    cv::Mat decode_img = cv::imdecode(src_code, CV_LOAD_IMAGE_COLOR);
    cv::imwrite(FILE, decode_img);
